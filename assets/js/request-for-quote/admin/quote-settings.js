jQuery(document).ready(function($){
	...
	// $('#b2be_rfq_enable_rfq').parent().addClass('switch');
	// $('#b2be_rfq_enable_rfq').parent().append('<span class="slider round"></span>');
	$("#b2be_rfq_enable_rfq").on("change",function(){
	...
	$("#b2be_rfq_disable_add_to_cart").on("change",function(){
	...
	$(".b2be_rfq_enable_rfq-edit").on("change",function(){
	...
	$(".b2be_rfq_disable_add_to_cart-edit").on("change",function(){
	...
	$("#b2be_rfq-options #enable_rfq").on("change",function() {
	...
	$("#b2be_rfq-options #disable_add_to_cart").on("change",function() {
