...
$quote = b2be_get_quote( $quote_id ); // phpcs:ignore WordPress.WP.GlobalVariablesOverride.OverrideProhibited
...
<section class="woocommerce-quote-details">
	<?php do_action( 'b2be_rfq_quote_details_before_quote_table', $quote ); ?>
	...
	<table class="woocommerce-table woocommerce-table--quote-details shop_table quote_details">
		...
		<tbody>
			<?php
			do_action( 'woocommerce_quote_details_before_quote_table_items', $quote );
	...
	<?php do_action( 'woocommerce_quote_details_after_quote_table', $quote ); ?>
</section>

<?php
$show_customer_details = true;
if ( $show_customer_details ) {
	wc_get_template( 'quote/quote-details-customer.php', array( 'quote' => $quote ), 'b2b-ecommerce-for-woocommerce', B2BE_TEMPLATE_DIR );
}
