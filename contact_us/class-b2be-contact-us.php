...
if ( ! class_exists( 'Codup_Contact_Us' ) ) {
	...
	class Codup_Contact_Us {
		...
		public function __construct() {
			...
			add_filter( 'plugin_action_links_b2b-ecommerce-for-woocommerce-lite/b2b-ecommerce-for-woocommerce-lite.php', array( $this, 'rfq_settings_link' ) );
		...
		public function rfq_support_and_faq_links( $links_array, $plugin_file_name, $plugin_data, $status ) {
			...
			if ( 'b2b-ecommerce-for-woocommerce-lite/b2b-ecommerce-for-woocommerce-lite.php' == $plugin_file_name ) {

				$links_array[] = 'Having trouble in configuration? <a href="http://ecommerce.codup.io/support/tickets/new" target="_blank">Get Support</a>';
