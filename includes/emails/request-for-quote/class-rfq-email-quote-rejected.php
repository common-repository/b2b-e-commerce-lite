...
if ( ! class_exists( 'RFQ_Email_Quote_Rejected', false ) ) :

	/**
	 *  Class RFQ_Email_Quote_Rejected
	 */
	class RFQ_Email_Quote_Rejected extends WC_Email {

		/**
		 * Constructor.
		 */
		public function __construct() {
			$this->id            = 'rejected_quote';
			$this->title         = __( 'Quote Rejected', 'b2b-ecommerce' );
			$this->description   = __( 'Quote rejected emails are sent to chosen recipient(s) when quote have been marked rejected by customer (if they were previously processing or quoted).', 'b2b-ecommerce' );
			$this->template_html = 'emails/admin-rfq-rejected.php';
		...
		public function get_default_subject() {
			return __( '[{site_title}]: Quote #{quote_number} has been rejected', 'b2b-ecommerce' );
		}
		...
		public function get_default_heading() {
			return __( 'Quote Rejected: #{quote_number}', 'b2b-ecommerce' );
		}
