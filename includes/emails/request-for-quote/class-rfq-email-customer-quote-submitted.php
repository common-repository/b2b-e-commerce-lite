...
if ( ! class_exists( 'RFQ_Email_Customer_Quote_Submitted', false ) ) :
	...
	class RFQ_Email_Customer_Quote_Submitted extends WC_Email {
		...
		public function get_subject() {
			...
			return apply_filters( 'b2be_rfq_email_subject_quote_submitted', $this->format_string( $subject ), $this->object, $this );
		}
		...
		public function get_heading() {
			...
			return apply_filters( 'b2be_rfq_email_heading_quote_submitted', $this->format_string( $heading ), $this->object, $this );
		}
