...
if ( ! class_exists( 'WC_Email_New_Comment' ) ) :

	/**
	 * WC_Email_New_Comment
	 */
	class WC_Email_New_Comment extends WC_Email {
		...
		public function __construct() {
			$this->id            = 'new_comment';
			$this->title         = __( 'New Comment For Admin', 'b2b-ecommerce' );
			$this->description   = __( 'New Comment emails are sent to chosen recipient(s) when a new Comment is received.', 'b2b-ecommerce' );
			$this->template_html = 'emails/admin-new-comment.php';
...
return new WC_Email_New_Comment();
