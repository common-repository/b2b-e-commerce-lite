...
if ( ! class_exists( 'WC_Email_New_RFQ_Email_To_Customer' ) ) :

	/**
	 * WC_Email_New_RFQ_Email_To_Customer
	 */
	class WC_Email_New_RFQ_Email_To_Customer extends WC_Email {

		/**
		 * Constructor.
		 */
		public function __construct() {
			$this->id             = 'new_rfq_to_customer';
			$this->customer_email = true;
			$this->title          = __( 'New RFQ Email To Customer', 'b2b-ecommerce' );
			$this->description    = __( 'New RFQ emails are sent to chosen recipient(s) when a new RFQ is received.', 'b2b-ecommerce' );
			$this->template_html  = 'emails/new-rfq-email-to-customer.php';
...
return new WC_Email_New_RFQ_Email_To_Customer();
