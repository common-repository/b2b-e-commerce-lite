	...
	class B2BE_RFQ_Quote {
		...
		protected function get_prop( $prop, $context = 'view' ) {
			...
			if ( array_key_exists( $prop, $this->data ) ) {
				...
				if ( 'view' === $context ) {
					$value = apply_filters( 'b2be_rfq_quote_get_' . $prop, $value, $this );
				}
			}
		...
		public function get_view_quote_url() {
			return apply_filters( 'b2be_rfq_get_view_quote_url', wc_get_endpoint_url( B2BE_VIEW_QUOTE_ENDPOINT, $this->get_id(), wc_get_page_permalink( 'myaccount' ) ), $this );
		}
