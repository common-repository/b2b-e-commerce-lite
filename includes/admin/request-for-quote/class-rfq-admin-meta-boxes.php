...
class RFQ_Admin_Meta_Boxes {
	...
	public function __construct() {
		...
		add_action( 'b2be_rfq_process_quote_meta', 'RFQ_Admin_Meta_Boxes::save', 40, 2 );
	}
	...
	public function add_meta_boxes() {
		add_meta_box( 'b2be-rfq-quote-data', sprintf( __( "Quote's data", 'b2b-ecommerce' ) ), 'RFQ_Admin_Meta_Boxes::quote_data_output', 'quote', 'normal', 'high' );
		add_meta_box( 'b2be-rfq-quote-item', sprintf( __( 'Items', 'b2b-ecommerce' ) ), 'RFQ_Meta_Box_Quote_Items::output', 'quote', 'normal', 'high' );
		add_meta_box( 'b2be-rfq-quote-comments', sprintf( __( 'RFQ Comments', 'b2b-ecommerce' ) ), 'RFQ_Meta_Box_Quote_Comments::output', 'quote', 'normal', 'high' );
	}
	/**
	 * Quote Data Output.
	 *
	...
	public function save_meta_boxes( $post_id, $post ) {
		...
		do_action( 'b2be_rfq_process_quote_meta', $post_id, $post );
	}
	/**
	 * Save meta box data.
	 *
