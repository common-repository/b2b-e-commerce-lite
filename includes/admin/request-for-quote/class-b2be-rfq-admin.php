...
class Codup_RFQ_Admin {
	...
	public function admin_scripts() {
		...
		if ( 'quote' == $screen_id ) {
			wp_enqueue_script( 'b2be-rfq-admin-quote-meta-boxes', B2BE_PLUGIN_DIR_URL . 'assets/js/request-for-quote/admin/meta-boxes-quote.js', array( 'jquery' ), true );
			wp_localize_script(
				'b2be-rfq-admin-quote-meta-boxes',
			...
			wp_enqueue_style( 'b2be-rfq-admin-quote-meta-boxes', B2BE_PLUGIN_DIR_URL . 'assets/css/request-for-quote/admin/meta-boxes-quote.css', '', true );
			wp_enqueue_style( 'b2be-rfq-admin-comment-meta-boxes', B2BE_PLUGIN_DIR_URL . 'assets/css/request-for-quote/admin-comment-metabox.css', '', true );
		}
	}
	/**
	...
	public function update_meta_key_to_display( $display_key, $meta ) {
		...
		if ( 'quote' == $display_key ) {
			$display_key = 'Associated Quote ID ';
		}
		return $display_key;
	}
	/**
