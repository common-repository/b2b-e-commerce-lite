		...
		<td class="item_cost" data-sort-value="<?php echo esc_attr( $quote->get_item_subtotal( $item, false, true ) ); ?>" >
			<div class="view">
				<?php if ( $product->is_type( 'variable' ) ) { ?>
					<span class="item_cost_span" id="actual_price_<?php echo esc_attr( $item->variation_id ); ?>" ><?php echo ( esc_attr( wc_format_localized_price( $item->subtotal ) / esc_attr( $item->qty ) ) ); ?></span>
				<?php } else { ?>
					<span class="item_cost_span" id="actual_price_<?php echo esc_attr( $product->get_id() ); ?>" ><?php echo ( esc_attr( wc_format_localized_price( $item->subtotal ) / esc_attr( $item->qty ) ) ); ?></span>
				<?php } ?>
			</div>
		</td>
		<td class="quantity">
			...
			<div class="edit">
				<div class="split-input">
					...
					<div class="input">
						...
						<?php if ( $product->is_type( 'variable' ) ) { ?>
							<p class="item_subtotal_<?php echo esc_attr( $item->variation_id ); ?>" ><?php echo esc_attr( wc_format_localized_price( $item->subtotal ) ); ?>
						<?php } else { ?>
							<p class="item_subtotal_<?php echo esc_attr( $product->get_id() ); ?>" ><?php echo esc_attr( wc_format_localized_price( $item->subtotal ) ); ?>
						<?php } ?>
					</div>
				</div>
			</div>
