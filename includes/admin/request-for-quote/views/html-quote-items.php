...
if ( ! empty( $line_items ) ) {
	?>
<div class="woocommerce_quote_items_wrapper b2be-rfq-quote-items-editable">
	<table cellpadding="0" cellspacing="0" class="woocommerce_quote_items">
		<thead>
			<tr>
				...
				<?php do_action( 'woocommerce_admin_quote_item_headers', $quote ); ?>
		...
		<tbody id="quote_line_items" style="text-align:center" >
			...
			<?php
			do_action( 'woocommerce_admin_quote_items_after_line_items', $quote->get_id() );
			?>
	</tbody>
	</table>   
</div>
