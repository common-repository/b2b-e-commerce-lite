...
if ( ! class_exists( 'B2B_Payment_Gateway_1' ) ) {

	/**
	 * B2B Custom Payment Method Class.
	 */
	class B2B_Payment_Gateway_1 extends WC_Payment_Gateway {
		...
		public function process_payment( $order_id ) {
			...
			$order->update_status( 'completed', $this->method_title );
